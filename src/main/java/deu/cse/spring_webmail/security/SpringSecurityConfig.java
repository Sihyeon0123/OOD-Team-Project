...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorizeRequests -> authorizeRequests
                ...
                .requestMatchers("/main_menu", "/change_password", "/change_password.do",
                        "/show_message", "/write_mail", "/show_message", "/test",
                        "/trash", "/show_send_me", "/show_sent_mail", "/addressbook")
                .hasAnyRole("USER", "ADMIN")
                .requestMatchers("/", "/login.do", "/isUserIDDuplicate", "/signup",
                        "/signup.do", "/login_fail").permitAll()
